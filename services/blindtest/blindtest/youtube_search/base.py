...
from blindtest.youtube_search.constants import SEARCH_KEY, USER_AGENT, SearchModes
from blindtest.youtube_search.models.videos import (SimpleChannelModel, ThumbnailModel,
                                          VideoModel)
from blindtest.youtube_search.query import Query, QueryDict, ResultsIterator


class BaseSearch[T]:
    model: T = None
    base_url: Optional[str] = None
    objects: ResultsIterator['BaseSearch', T] = ResultsIterator()
    ...
    def result_generator(self, queryset) -> Iterator:
...
class Videos(ModelsGeneratorMixin, BaseSearch):
    ...
    def result_generator(self, queryset: Query) -> Iterator:
        for item in queryset:
...
class Channels(BaseSearch[SimpleChannelModel]):
