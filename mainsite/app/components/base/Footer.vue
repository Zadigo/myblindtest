<template>
  <footer class="flex flex-col bg-primary-500 text-primary-50 dark:bg-primary-950 items-center justify-around w-full py-16 text-sm">
    <div class="flex items-center gap-8">
      <a href="#" class="font-medium text-primary-50 hover:text-primary-300 transition-all">
        Home
      </a>
      <a href="#" class="font-medium text-primary-50 hover:text-primary-300 transition-all">
        About
    ...
    <div class="flex items-center gap-4 mt-8 text-primary-50 dark:text-primary-300">
