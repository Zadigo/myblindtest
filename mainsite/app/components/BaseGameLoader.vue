...
.loader {
  --size: 250px;
  --duration: 2s;
  --logo-color: var(--p-primary-50);
  --background: linear-gradient(0deg, var(--p-primary-300) 0%, var(--p-primary-50) 100%);
  height: var(--size);
  aspect-ratio: 1;
  position: relative;
}
...
@keyframes ripple {
  0% {
    transform: scale(1);
    box-shadow: var(--p-primary-500) 0px 10px 10px -0px;
  }

  50% {
    transform: scale(1.3);
    box-shadow: var(--p-primary-400) 0px 10px 10px -0px;
  }

  100% {
    transform: scale(1);
    box-shadow: var(--p-primary-100) 0px 10px 10px -0px;
  }
}
