...
<style scoped>
#jokers>div::-webkit-scrollbar {
  display: none;
}

.inner-shadow {
  box-shadow: inset 0 4px 24px var(--color-primary-100);
}

.dark .inner-shadow, .p-dark .inner-shadow {
  box-shadow: inset 0 4px 24px var(--color-primary-800);
}
</style>
